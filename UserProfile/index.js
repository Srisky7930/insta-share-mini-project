...
class UserProfile extends Component {
  ...
  onClickFollowButton = () => {
    this.setState(prevState => ({
      showFollow: !prevState.showFollow,
    }))
  }

  getUserProfileSuccess = () => {
    const {userProfile, posts, stories, showFollow} = this.state
    const {
      userName,
      profilePic,
      postsCount,
    ...
    const followCss = showFollow ? 'follow-button' : 'follow-button2'
    return (
